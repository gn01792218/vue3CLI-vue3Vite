<template>
  <div class="announcement w-100 h-100 position-absolute">
    ...
    <div class="announcement-container position-absolute p-4">
      ...
      <section
        id="announcement1"
        class="announcement-body mb-4"
        v-show="currentAnnouncement == 0"
      >
        ...
        <div class="d-flex align-items-center flex-column">
          <div class="form-group form-check d-flex align-items-center">
            <input
              type="checkbox"
              class="mr-2"
              id="announcementCheck1"
              v-model="announcementData1.checked"
            />
          ...
          <i
            ...
            @click="setCurrentAnnouncement(1)"
          ></i>
        </div>
      </section>
      <section
      ...
      >
        ...
        >
          <p class="announcementTitle">{{ i.title }}</p>
          <div
            :id="`announcementContent2-${index}`"
            class="announcementContent"
          ></div>
        </div>
        <div>
          <p class="announcementTitle"><br />臨時公告事項:</p>
          <div v-for="(i, index) in announment" :key="index">
            {{ i.message }}
          </div>
        </div>
        <div class="d-flex align-items-center flex-column">
          <div class="form-group form-check d-flex align-items-center">
            <input
              type="checkbox"
              class="mr-2"
              id="announcementCheck2"
              v-model="announcementData2.checked"
            />
          ...
          <div class="d-flex">
            <i
              ...
              @click="setCurrentAnnouncement(0)"
            ></i>
            <i
              class="bi bi-arrow-right-square"
              @click="setCurrentAnnouncement(2)"
            ></i>
          </div>
        </div>
      </section>
        ...
        <div class="d-flex align-items-center flex-column">
          <div class="form-group form-check d-flex align-items-center">
            <input
              type="checkbox"
              class="mr-2"
              id="announcementCheck3"
              v-model="announcementData3.checked"
            />
