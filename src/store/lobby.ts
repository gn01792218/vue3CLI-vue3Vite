export const state = {
  ...
  //       {
  //         title:'',
  //         content:'5．遊戲中若荷官於押分之前，<span>不慎先開牌</span>，無論幾張，<span>該局押分皆視為無效，並結束當靴開始新局。</span><br/><br/>'
  //       },
  //       {
  //         title:'**荷官發牌規則**',
  //         content:''
  ...
  //       {
  //         title:'',
  //         content:'1．當洗牌途中牌不慎掉落／散開，當局重新更換整副新牌並且重新洗牌。'
  //       },
  //       {
  //         title:'',
  //         content:'2．當牌局出現鬼牌或空白牌時，當局和局，派彩後退回所有下注，重啟新局重新洗牌。'
  //       },
  //       {
  //         title:'',
  //         content:'3．發生不當補牌／不當亮牌時，當局正常輸贏，已亮之牌為下一局閒家第一張牌，下局以飛牌處理不接受投注。'
  //       },
  //       {
  //         title:'',
  //         content:'4．發生不當補牌／不當亮牌時，荷官未注意而開啟下局時，上局結果由客服調回放確認無誤後正常輸贏，重啟新局重新洗脾。'
  //       },
  //       {
  //         title:'',
  //         content:'5．派牌途中若荷官不慎拉出兩張或三張陰牌時，由監牌人員指示依順序放於畫面中，當局繼續。下一局依照順序發牌，不得有議。'
  //       },
  //       {
  //         title:'',
  //         content:'6．出白卡若當局補牌有過白卡，則當局為最後一局；若當局無過白卡，則當局結束後尚有下一局。'
  //       },
  //       {
  //         title:'',
  //         content:'7．當荷官燒牌進行時不慎拉出兩張或三張陰牌，由監牌人員指示依順序放於畫面中，此陰牌則為下局閒家第一張牌開始發牌，若荷官燒牌張數未正確並已截圖送出，則整副牌組做廢並重新洗牌。'
  //       },
  //       {
  //         title:'',
  //         content:'8．若荷官不慎在停止下注前亮牌，派彩後退回所有下注，不得有議。'
  //       },
  //       {
  //         title:'',
  //         content:'9．如遇荷官勝負牌放置錯誤導致派彩結果錯誤，本公司有權重新派彩，不得異議。'
  //       },
  //     ]
  //   },
  //   announcement3:{
