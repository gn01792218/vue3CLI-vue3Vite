  ...
  announcement:{
    ...
    announcement2:{
      ...
      content:[
        ...
        {
          title:'',
          content:'4.遊戲中荷官<span>不填同時抽出兩張牌</span>，無論辨識與否，荷官都將依正確順序辨識後繼續運行，<span>該局押分視為無效予以退分並結束當靴開始新局</span>。'
        },
        {
          title:'',
          content:'5．遊戲中若荷官於押分之前，<span>不慎先開牌</span>，無論幾張，<span>該局押分皆視為無效，並結束當靴開始新局</span>。'
        },
      ]
    },
    announcement3:{
