  ...
  announcement:{
    ...
    announcement2:{
      ...
      content:[
        {
          title:'敬愛的玩家您好',
          content:'1．視訊遊戲中如遇&lt;span&gt;遊戲牌組辨識錯誤&lt;/span&gt;或<span>荷官操作失誤</span>致使以錯誤結果計算時，本局押分視為有效，並且遊戲結果依現場牌型為依據作為正確結果重新計算。'
        },
        {
          title:'',
          content:'2．因不可歸責本遊戲或不可抗力因素所造成之遊戲停止或中斷，此局將不予計分予以退分作為處理。'
        },
        {
          title:'',
          content:'3．遊戲中如遇玩家網路不穩造成瞬斷或視訊畫面延遲時，玩家可以選譯停止下注或退出遊戲重新登入，如已押分仍視為有效。'
        },
        {
          title:'',
          content:'4.遊戲中荷官不填同時抽出兩張牌，無論辨識與否，荷官都將依正確順序辨識後繼續運行，該局押分視為無效予以退分並結束當靴開始新局。'
        },
        {
          title:'',
          content:'5．遊戲中若荷官於押分之前，不慎先開牌，無論幾張，該局押分皆視為無效，並結束當靴開始新局。'
        },
      ]
    },
    announcement3:{
